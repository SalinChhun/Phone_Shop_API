package com.kosign.phone_shop.specification;
...
//            Predicate pr = cb.like(cb.upper(brand.get("name")), "%"+brandFilter.getName().toUpperCase()+"%");
//            predicates.add(pr);
        }
...
//        return cb.and(predicates.toArray(new Predicate[0])) //<= java7;
